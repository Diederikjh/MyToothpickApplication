...
public class SimpleApp extends Application {
    ...
    public void onCreate() {
       ...
       /* Toothpick.setConfiguration(Configuration.forProduction().disableReflection());
        MemberInjectorRegistryLocator.setRootRegistry(new com.honeybeeapp.toothpicktest.mytoothpickapplication.MemberInjectorRegistry());
        FactoryRegistryLocator.setRootRegistry(new com.honeybeeapp.toothpicktest.mytoothpickapplication.FactoryRegistry());*/
